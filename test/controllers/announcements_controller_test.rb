...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { announcement_date: @announcement.announcement_date, is_for_all: @announcement.is_for_all, message: @announcement.message } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { announcement_date: @announcement.announcement_date, is_for_all: @announcement.is_for_all, message: @announcement.message } }
