...
class InventoryItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory_item" do
    assert_difference('InventoryItem.count') do
      post inventory_items_url, params: { inventory_item: { book: @inventory_item.book, class_level: @inventory_item.class_level } }
    end
  ...
  test "should update inventory_item" do
    patch inventory_item_url(@inventory_item), params: { inventory_item: { book: @inventory_item.book, class_level: @inventory_item.class_level } }
