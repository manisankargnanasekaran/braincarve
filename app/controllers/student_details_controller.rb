class StudentDetailsController < ApplicationController
  ...
  private
    ...
    def student_detail_params
      params.require(:student_detail).permit(:student_id, :father_name, :father_occupation, :father_email, :father_contact_no, :mother_name, :mother_occupation, :mother_email, :mother_contact_no, :known_by, :reason_to_enroll)
    end
end
